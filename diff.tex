...
% 1st. author
\alignauthor
\DIFdelbegin \DIFdel{Mukesh Saini}\DIFdelend \DIFaddbegin \DIFadd{sahil gupta}\DIFaddend \\
       \affaddr{Dept. of Computer Science}\\
       \affaddr{National University of Singapore}\\
       \email{mksaini@comp.nus.edu.sg}
% 2nd. author
\alignauthor
\DIFdelbegin \DIFdel{Raghudeep Gadde  }\DIFdelend \DIFaddbegin \DIFadd{abhishek goyal  }\DIFaddend \\     
       \affaddr{Dept. of ECE}\\
       \affaddr{National University of Singapore}\\
...
% 3rd. author
\alignauthor
\DIFdelbegin \DIFdel{Shuicheng Yan}\DIFdelend \DIFaddbegin \DIFadd{abhishek singh}\DIFaddend \\
        \affaddr{Dept. of ECE}\\
       \affaddr{National University of Singapore}\\
       \email{elerdg@nus.edu.sg}
% 4th. author
\alignauthor 
\DIFdelbegin \DIFdel{Wei Tsang Ooi     }\DIFdelend \DIFaddbegin \DIFadd{abhishek dawas    }\DIFaddend \\  
       \affaddr{Dept. of Computer Science}\\
       \affaddr{National University of Singapore}\\
...
\DIFdelbegin \DIFdel{There has been only few works on online camera selection }\DIFdelend \DIFaddbegin \DIFadd{Online camera selection is only worked on a few times}\DIFaddend . In
...
\DIFdelbegin \DIFdel{In this section, we first }\DIFdelend \DIFaddbegin \DIFadd{first we }\DIFaddend enumerate the design principles \DIFdelbegin \DIFdel{that we
have followed in the development of MoViMash and then describe
the framework. After an overview of MoViMash, }\DIFdelend \DIFaddbegin \DIFadd{then }\DIFaddend we focus on \DIFdelbegin \DIFdel{in-
dividual }\DIFdelend \DIFaddbegin \DIFadd{the individual }\DIFaddend components.
...
\section{Evaluation}
The \DIFdelbegin \DIFdel{main goal of the experiments is to show that the proposed
framework produces a mashup with better view quality and diver-
sity than }\DIFdelend \DIFaddbegin \DIFadd{new framework has a better mashup quality and also a better driversity thsn }\DIFaddend earlier works. In addition, we also compare our result with
...
\DIFdelbegin \DIFdel{In this paper, we have proposed and validated an online video
mashup creation framework, MoViMash, for videos recorded by
mobile devices . }\DIFdelend \DIFaddbegin \DIFadd{We introduced a new framwork which orks on mobile devices and we also validated it.It is called movimash. }\DIFaddend Based on the experiments and user study, we make
...
\DIFdelbegin \DIFdel{This research is conducted under the NExT Search Center, sup-
ported by the }\DIFdelend Singapore National Research Foundation and the In-
teractive Digital Media R&D Program Office of Media Develop-
ment Authority  \DIFdelbegin \DIFdel{under research grant WBS:R-252-300-001-490.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{supported this research by giving a research grant.
